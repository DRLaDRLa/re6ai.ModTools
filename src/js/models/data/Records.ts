export default class Records {
    ...
    public static readonly Reasons = {
        ...
        lowtags: {
            text: "You are expected to add at least 10 general category tags when uploading posts.",
            rules: "tagging"
        },
        adverts: {
            text: "Do not advertise paid/paywalled content on e6ai.",
            rules: "advertising"
        },
        inappropriate: {
        ...
        blacklist: {
            text: "Please use your [[e6ai:blacklist|blacklist]].",
            rules: "blacklist",
        },
        blacklist2: {
            text: "[[e6ai:blacklist|Blacklist]] quietly, please.",
            rules: "blacklist",
        },
        roleplay: {
        ...
        underage: {
            text: "You need to be 18 to access this page.\nThis ban won't expire, but if you have reached the sufficient age you can request your ban to be lifted by writing an email to management@e6ai.net.",
            rules: "underage",
        },
    };
    ...
    public static readonly Rules: { [name: string]: SiteRule } = {
        ...
        advertising: {
            ...
            group: this.RuleGroups.messages,
            rules: [
                "Do not advertise on e6ai.", '* No advertisements for paid content of any kind.', '* No paywall logos (e.g. Patreon).', '* No mentions or links to paywalled content in the description or source.', '* No indirect advertising (This includes links to social media profiles, "Linktrees," or landing pages that primarily serve to redirect users to paywalled content.)'
            ],
            postface: 'Exceptions: Tip jars and Commissions using the "Commission Info" field on your profile is allowed. See the "advertisement section of the uploading guidelines":/wiki_pages/uploading_guidelines#ads for more info.'
        },
        ...
        posting: {
            ...
            rules: [
                'Do not knowingly or repeatedly upload content that goes against the "Uploading Guidelines":/help/uploading_guidelines.', '* Do not post works made by any of the directors or publishers on the "Avoid Posting list":/static/avoid_posting or break any uploading conditions set there.', '* Do not post any commercial or pay-to-view content. "Free" pay-to-view content – where you are allowed to set the price to $0 if you so choose – cannot be posted unless 60 days have passed after it was made available for free.', "* Do not knowingly upload or share previously deleted content. If you wish to dispute a post's removal, contact the staff member responsible for the deletion via a private message.", "Do not knowingly or repeatedly upload or share unauthorized edits of artwork after the original artist or character owner asked others not to.", "Do not knowingly or repeatedly upload content made by minors or featuring characters created or owned by minors.", "* Do not upload content that was made when the artist was underage, even if they are of age now.", 'Do not upscale or otherwise manipulate images to artificially create a "better" version of an existing image.', "Do not upload content that is associated with recent real-life tragedies."]
        },
        insufficient_tagging: {
            title: "Insufficient tagging",
            group: this.RuleGroups.posts,
            rules: [
                "You are expected to add at least 10 general non-implied tags when uploading posts.",
                '* Please see our "Tagging Checklist":/help/tagging_checklist, view our "Uploading Guidelines":/help/uploading_guidelines, and consider using the "Related Tags" function on the upload form',
                '* Use the "wiki":/wiki/show?title=help:home if you need help understanding the usage of any tags, or ask us on "Discord":/static/discord. You can also search our "Forum":/forum_topics.'
            ],
            postface: 'This restriction will be eased if the post does not have ten distinct tags that are reasonably applicable to it.',
            link: "/wiki_pages/e6ai:rules#tagging"
        },
        tagging: {
        ...
        underage: {
            ...
            group: this.RuleGroups.illegal,
            preface: "By using this site and/or registering an account, you agree that you are at least eighteen years of age. No individual under the age of eighteen may register an account, use our services, provide any personal information to e6ai, or otherwise upload or transmit personal information through our services.",
            rules: [],
            postface: "Even though laws may vary depending on your location, e6ai.net's management and service office is located in Arizona, USA, and it is those laws that we are required to abide by. We cannot knowingly allow any minors to view pornographic content, so we must be proactive in preventing underage access. This includes accounts that are either legally or illegally accessed by minors. Furthermore, we require official, government-issued photo identification as proof of you turning eighteen in order to release access to your account. Please email us at `management@e6ai.net` for further details.",
        },
    };
