...
export default class REMT {
    ...
    public async run(): Promise<void> {
        ...
        Promise.all(promises).then(() => {
            ...
            if (configs.length <= 0) {
              console.log("%c[RE6AI.ModTools]%c loaded; no settings to load", "color: maroon", "color: unset");
              return;
            }
            console.log("%c[RE6AI.ModTools]%c loaded; loading %s settings...", "color: maroon", "color: unset", configs.length);
            ...
            console.log("%c[RE6AI.ModTools]%c fully loaded.", "color: maroon", "color: unset");
        });
    }
